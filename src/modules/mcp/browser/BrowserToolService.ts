...
import { HttpProtocolRecordBuilderFactory } from '@/modules/journey/index.js';
...
export class BrowserToolService implements ToolService<BrowserToolContext, BrowserToolOutput> {
    constructor(
        @inject(dependencies.ProtocolRecordBuilderFactory) private readonly protocolRecordBuilderFactory: HttpProtocolRecordBuilderFactory,
