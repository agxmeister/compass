...
import { HttpDriverFactory, type DriverFactory } from './modules/driver/index.js';
...
container.bind<DriverFactory>(dependencies.BrowserDriverFactory).to(HttpDriverFactory);
