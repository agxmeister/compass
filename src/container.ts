...
import { AxisServiceFactory, type BrowserServiceFactory, type CreateSessionResponse, type DeleteSessionResponse, type PerformActionResponse } from './modules/browser/index.js';
...
container.bind<BrowserServiceFactory<CreateSessionResponse, DeleteSessionResponse, PerformActionResponse>>(dependencies.BrowserServiceFactory).to(AxisServiceFactory);
